#######################################################################################
# Script: Univariate data management function
# Date: 20/03/24
# Author: Matt Pryce 
# Notes: When running any univariate models (T-learner, DR-learner, mDR-learner, EP-leanrer)
#        this function checks the input data is correctly formatted. 
#######################################################################################
